(function($) {        
    $.alerts = {         
        ...
        _show: function(title, msg, value, type, callback) {  
                    ...
                    _html += '  <div class="alert alert-danger alert-dismissible fade show">';  
                    _html += '<button type="button" class="btn-close" data-bs-dismiss="alert"></button>';  
                      if (type == "alert") {  
						_html += '<strong>False!</strong>'+msg; 
						_html += '</div>';					  
                    }  
                    if (type == "confirm") {  
